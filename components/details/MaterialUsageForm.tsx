                    ...
                    <View style={styles.header}>
                        <View style={styles.headerLeft}>
                            <View style={styles.iconContainer}>
                                <Ionicons name="arrow-forward-circle" size={24} color="#3A78B5" />
                            </View>
                            <View>
                            ...
                            <>
                                ...
                                <View style={styles.sectionInfo}>
                                    <View style={styles.sectionInfoHeader}>
                                        ...
                                        >
                                            <Ionicons name="arrow-back" size={16} color="#3A78B5" />
                                        </TouchableOpacity>
                        ...
                        {currentStep === 'workArea' ? (
                            ...
                            <>
                                ...
                                <TouchableOpacity
                                    style={[
                                        styles.nextButtonLarge,
                                        (!canSubmitForm() || isSubmittingUsage) && styles.nextButtonDisabled
                                    ]}
                                    onPress={handleSubmit}
                                    disabled={!canSubmitForm() || isSubmittingUsage}
                                    activeOpacity={0.8}
                                >
                                    <Text style={styles.nextButtonText}>Record Material Usage</Text>
            ...
            {isSubmittingUsage && (
                <View style={styles.loadingOverlay}>
                    <View style={styles.loadingContainer}>
                        ...
                        >
                            <Ionicons name="arrow-forward-circle" size={48} color="#3A78B5" />
                        </Animated.View>
